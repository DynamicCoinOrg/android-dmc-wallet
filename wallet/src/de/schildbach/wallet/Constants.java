...
public final class Constants
{
	...
	public final static class Files
	{
		...
		public static final String EXTERNAL_WALLET_KEY_BACKUP = "dynamiccoin-wallet-keys" + FILENAME_NETWORK_SUFFIX;

		/** Filename of the manual wallet backup. */
		public static final String EXTERNAL_WALLET_BACKUP = "dynamiccoin-wallet-backup" + FILENAME_NETWORK_SUFFIX;
	...
	private static final String BITEASY_API_URL_PROD = "";
	private static final String BITEASY_API_URL_TEST = "";
	...
	public static final String VERSION_URL = "https://android-wallet.dynamiccoin.org/version";

	/** MIME type used for transmitting single transactions. */
	public static final String MIMETYPE_TRANSACTION = "application/x-dmctx";

	/** MIME type used for transmitting wallet backups. */
	public static final String MIMETYPE_WALLET_BACKUP = "application/x-dynamiccoin-wallet-backup";

	/** Number of confirmations until a transaction is fully confirmed. */
	public static final int MAX_NUM_CONFIRMATIONS = 7;

	/** User-agent to use for network access. */
	public static final String USER_AGENT = "DynamicCoin Wallet";
	...
	public static final String REPORT_EMAIL = "webmaster@dynamiccoin.org";
	...
	public static final String SOURCE_URL = "https://github.com/DynamicCoinOrg/android-dmc-wallet";
	public static final String BINARY_URL = "https://github.com/DynamicCoinOrg/android-dmc-wallet/releases";
